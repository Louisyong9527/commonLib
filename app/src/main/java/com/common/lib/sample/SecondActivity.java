...
//                AndroidUtils.startToLastActivity(SecondActivity.this,MainActivity.class,null,true);

                AndroidUtils.showToast(getBaseContext(),SecondActivity.this,"this is a toast");
            }
        });
